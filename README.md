...
🎓  College  : Manipal University, Jaipur (B.Tech Data Science)
📧  Email    : jyotheeswar0802@gmail.com
📞  Phone    : +91 8712700720
📍  Location : Madanapalle, AP 517325 · India 🇮🇳
...
⚡  Fun Fact    : Karate Black Belt + National Olympiad Medalist! 🥋🏅
```
...
### 🤖 Intelligent Swarm Robotics – Thermal Analytics  `2025–Present` `Patent Filed`

> 🔬 **Architected a decentralised multi-agent robotic system (Python) for smart sports infrastructure maintenance; integrated thermal analytics pipelines for automated field health monitoring. Managed full patent lifecycle — technical docs, prior-art research, and compliance.**

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white)
![ROS](https://img.shields.io/badge/ROS-22314E?style=flat-square&logo=ros&logoColor=white)
![Patent](https://img.shields.io/badge/Patent-Filed-success?style=flat-square)

```
🏗️  Architecture  : Decentralised multi-agent robotic system
🌡️  Analytics     : Real-time thermal analytics pipelines
📊  Dashboards    : Predictive maintenance dashboards
📄  Patent        : Full lifecycle managed ✅
```

---

### 🌱 Swarm Robotics – Autonomous Garden Maintenance  `2025` `Patent Filing in Progress`

> 🌿 **Multi-robot swarm with stigmergy-based coordination; OpenCV + custom CNN classifies plant health and triggers interventions — ~60% reduction in manual effort. Real-time sensor fusion feeds a predictive irrigation ML model.**

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white)
![CNN](https://img.shields.io/badge/CNN-Deep%20Learning-FF6F00?style=flat-square)
![Sensor Fusion](https://img.shields.io/badge/Sensor%20Fusion-🌡️-blueviolet?style=flat-square)

```
🤝  Coordination  : Stigmergy-based swarm coordination
🌿  Vision        : OpenCV + custom CNN plant health classifier
💧  Irrigation    : Predictive ML model (soil/temp/humidity)
⚡  Impact        : ~60% reduction in manual effort
```

---

### 🏏 Cricket Data Analytics  `ML · Python · scikit-learn`

> 📊 **Predictive models (classification & regression) for player performance and match outcomes; end-to-end pipeline from raw data ingestion (Pandas/NumPy) to model deployment.**
...
> 💬 **Transformer-based conversational AI for teenagers; multi-class sentiment classification with robust handling of imbalanced datasets; REST API integration for deployment.**

![NLP](https://img.shields.io/badge/NLP-Transformer-FF6F00?style=flat-square)
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
...
| 📜 Certificate | 🏫 Issuer |
|---|---|
| Intro to Python | University of Leeds |
| AWS Cloud Technical Essentials | Amazon Web Services |
| Digital Skills: AI | — |
| Java Programming – Arrays & Lists | — |
...
```
🥋  Karate Black Belt
🏅  National Olympiad Medalist  (IMO · NSO · UCO · UIEO)
🏏  District-Level Kabaddi Player
🧮  Abacus State Level Winner
🎭  School Sports & Cultural Captain  (Led 1,000+ students)
```
